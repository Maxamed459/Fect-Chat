...
const Sidebar = ({ selectedUser, setselectedUser }) => {
  ...
  return (
    <div
      className={`bg-[#000b58]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${
...
group-hover:block"
        ...
        <div className="bg-[#000b58] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
        ...
        {userDummyData.map((user, index) => (
          <div
            ...
            className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${
              selectedUser?._id === user._id && "bg-[#000b58]/50"
            }`}
          >
            <img
